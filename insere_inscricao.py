...
#     planilha_geral = pd.read_excel(planilha_geral_path, dtype={'CNPJ': str})
#
#     codigos_clientes = []
...
#             codigo_cliente = linha_correspondente.iloc[0]['IE']
...
#
# insere_codigo('\\\\192.168.10.51\\Dados\\Departamental\\TI\\!CIGAM\\Migracao\\Dados Usados para Migração\\Docs - Importacao - Cigam\\EMPRESAS_MODELOONDEPERMANECE O COD ANTERI - PRINCIPAL - Copia.xlsx', '\\\\192.168.10.51\\dados\\Departamental\\TI\\!CIGAM\\Migracao\\Dados Coletados para Migração\\IE.xlsx')
...
insere_codigo('\\\\192.168.10.51\\Dados\\Departamental\\TI\\!CIGAM\\Migracao\\Dados Usados para Migração\\Docs - Importacao - Cigam\\EMPRESAS_MODELOONDEPERMANECE O COD ANTERI - PRINCIPAL - Copia - Copia.xlsx', '\\\\192.168.10.51\\dados\\Departamental\\TI\\!CIGAM\\Migracao\\Dados Usados para Migração\\Docs - Importacao - Cigam\\CLIENTES SEM IE.xlsx')
